...
All parts from the JLCPCB/LCSC library, stock checked 2026-07-13. Datasheets
in `reference/datasheets/` (named `PART_usage_MFR_C#.pdf`).
⚠ = LCSC number pending re-verification (agent running; corrections will land
in the schematics + production BOM).
...
| 2.2 µF 50 V 0805 | 96 | C28323 ⚠ | channel VIN cap |
...
| SWPA6045S470MT 47 µH | 1 | C2896384 ⚠ | 5V buck inductor |
| 100 µF 50 V elec | 1 | C134722 ⚠ | 5V buck input |
| 220 µF 16 V elec | 1 | C134727 ⚠ | 5V rail output |
| 220 µF 35 V elec | 4 | C134728 ⚠ | 24 V bulk |
...
| LED 0805 green/blue/red | 1+1+1 | C2297/C2293/C84256 ⚠ | PWR/STATUS/FAULT |
| 2.2k + 1k 0603 | 1+2 | C4190/C21190 ⚠ | indicator series R |
...
| Pin header 1×02 | 1 | C2337 ⚠ | fan connector |
