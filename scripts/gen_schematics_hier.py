...
def main():
    ...
    for j in range(1, 7):
        led_pos[f"J{j}"] = (dd.snap(480.06 + ((j - 1) % 3) * 38.1),
                            266.7 if j <= 3 else 393.7)
    led_pos["J9"] = (571.5, 355.6)
    for i in range(1, 4):
    ...
    pos.update({
        ...
        "J12": (281.94, 448.31), "J7": (317.5, 448.31),
        ...
        "J4": (787.4, 63.5), "J5": (812.8, 63.5), "J6": (838.2, 63.5),
        "J9": (812.8, 190.5),
    })
    for i in range(1, 13):
